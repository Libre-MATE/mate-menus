...
#error \
    "libmate-menu should only be used if you understand that it's subject to frequent change, and is not supported as a fixed API/ABI or as part of the platform"
#endif
...
#define MATEMENU_TREE(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), MATEMENU_TYPE_TREE, MateMenuTree))
#define MATEMENU_TREE_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), MATEMENU_TYPE_TREE, MateMenuTreeClass))
#define MATEMENU_IS_TREE(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), MATEMENU_TYPE_TREE))
#define MATEMENU_IS_TREE_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), MATEMENU_TYPE_TREE))
#define MATEMENU_TREE_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), G_TYPE_DESKTOP_APP_INFO, MateMenuTreeClass))
